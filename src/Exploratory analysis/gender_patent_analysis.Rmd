...
yearlist <- unique(inventor_status$year)
...
```{r}
# plot
# description of inventors  ylim(0,5000) +
...
```{r}
# Education data
#ncses_doctorate <- read_csv("src/education/ncses_doctorate.csv")
...
plt17 <- ggplot(subset(ncses_doctorate01, (field=='pharmaceuticals') & (gender %in% c('men','women')) ), aes(x=year, y=value, fill=gender)) + 
  ...
  ylim(0,15000) +
  scale_fill_manual(values=gender.pallete) +
  labs(x = "year", y="Number of graduated doctoral students", title='Pharmaceuticals field', fill='') + 
  theme(plot.title = element_text(size=10))
...
plt18 <- ggplot(subset(ncses_doctorate01, (field=='civil engineering') & (gender %in% c('men','women')) ), aes(x=year, y=value, fill=gender)) + 
  ...
  ylim(0,15000) +
  scale_fill_manual(values=gender.pallete) +
  labs(x = "year", y="Number of graduated doctoral students", title='Civil engineering field', fill='') + 
  theme(plot.title = element_text(size=10))
...
plt17a <- ggplot(subset(ncses_doctorate02, (gender %in% c('all')) ), aes(x=year, y=value, fill=gradfield)) + 
  ...
  labs(x = "year", y="Number of PhD graduated students", title='Pharmaceuticals', fill='') + 
  theme(plot.title = element_text(size=10))

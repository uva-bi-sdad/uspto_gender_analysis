...
write_csv(sdp_df, "../../data/PatentsView/final/pharma_source_dest_pairs.csv")
...
sdp_df <- read_csv("../../data/PatentsView/final/pharma_source_dest_pairs.csv")
...
data[data$dest == "South San Francisco, CA", "dest"] <- "South                  \nSan Francisco, CA"
...
mig_chord(data, label_size = 0.5, axis_size = 0.5, preAllocateTracks = list(track.height = 0.25))
...
```{r}
pdf(file = "figures/pharma_migration.pdf")
...
pdf_convert(
  pdf = "figures/pharma_migration.pdf",
  format = "png",
  dpi = 200,
  filenames = "figures/pharma_migration.png"
)
...
pdf(file = "figures/pharma_migration_country.pdf")
...
pdf_convert(
  pdf = "figures/pharma_migration_country.pdf",
  format = "png",
  dpi = 200,
  filenames = "figures/pharma_migration_country.png"
)
...
pdf(file = "figures/pharma_migration_state.pdf")
...
pdf_convert(
  pdf = "figures/pharma_migration_state.pdf",
  format = "png",
  dpi = 200,
  filenames = "figures/pharma_migration_state.png"
)
...
**Pharma Engineering Inventors - Women**
...
write_csv(sdp_df, "../../data/PatentsView/final/pharma_W_source_dest_pairs.csv")

```

```{r}
sdp_df <- read_csv("../../data/PatentsView/final/pharma_W_source_dest_pairs.csv")
```
...
pdf(file = "figures/pharma_W_migration.pdf")
mig_chord(data, label_size = 0.8, axis_size = 0.7, preAllocateTracks = list(track.height = 0.25))
dev.off()
...
pdf_convert(
  pdf = "figures/pharma_W_migration.pdf",
  format = "png",
  dpi = 200,
  filenames = "figures/pharma_W_migration.png"
)
...
pdf(file = "figures/pharma_W_migration_country.pdf")
...
pdf_convert(
  pdf = "figures/pharma_W_migration_country.pdf",
  format = "png",
  dpi = 200,
  filenames = "figures/pharma_W_migration_country.png"
)
...
pdf(file = "figures/pharma_W_migration_state.pdf")
mig_chord(data, label_size = 1.0, axis_size = 0.8)
dev.off()
...
pdf_convert(
  pdf = "figures/pharma_W_migration_state.pdf",
  format = "png",
  dpi = 200,
  filenames = "figures/pharma_W_migration_state.png"
)
